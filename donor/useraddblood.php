...
?>
    <?php include 'includes/donornav.php'?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class=".col-lg-12">
                    <h1 class="page-header">Donate Blood</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Please fill up the details for the donor:
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="useraddedblood.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value='<?=$_SESSION["user_id"]?>' type="text" name="name" required>
                                        </div>
