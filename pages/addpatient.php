...
<body>
    ...
    <?php include 'includes/nav.php'?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Patient's Detail</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="addedpatient.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>Description for Medical history of Patient (if any)</label>
                                            <input class="form-control" placeholder="dibetic , xyz" name="medical" >
                                        </div>
...
<option value="AB+">AB positive</option>
  <option value="AB-">AB negative</option></select>                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" placeholder="Contact Number exclude +91" name="contact" required>
                                        </div>
