...
$qry="SELECT bloodgroup, count(*) as number FROM blood  where status='Approved' GROUP BY bloodgroup";
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                <?php include 'counter/dashpatientcount.php';?>
                                    <div class="huge"> </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                <?php include 'counter/dashordercount.php';?>
                                    <div class="huge"> </div>
                                    <div>Total Order</div>
                                </div>
                            </div>
