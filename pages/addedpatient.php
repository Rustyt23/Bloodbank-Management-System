...
$qry = "insert into patient(name,gender,dob,weight,blood_grp,email,address,contact,medical_history) values ('$name','$gender','$dob','$weight','$bloodgroup','$email','$address','$contact','No Medical History')";
