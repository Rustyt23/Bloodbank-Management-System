        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Edit Patient's Detail</h1>
...
$qry= "select * from patient where email='$id'";
#cho $qry;
...
?>                                    
                                    ...
                                    <form role="form" action="editp.php" method="post">
...
<input name="id" type="hidden" value="<? php echo $row['email']; ?>" >
