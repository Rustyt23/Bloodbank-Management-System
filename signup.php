...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Signup as Donor</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Please fill up the form below to Signup
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="added.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="name" type="text" placeholder="Example:Itachi Uchiha" required>
                                        </div>
                                        <div class="form-group">
...
<option value="O-">O negative</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" placeholder="Contact Number excluding +91" name="contact" required>
                                        </div>
...
<input type='hidden' name='send' value='1' >
                                        ...
                                        <button type="submit" class="btn btn-success" class="btn btn-success" style="border-radius:0%";>Sign Up</button>
